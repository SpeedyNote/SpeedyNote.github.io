...
wget $BASE_URL/$WINDOWS $BASE_URL/$WINDOWS_I386 $BASE_URL/$WINDOWS_ARM $BASE_URL/$MACOS $BASE_URL/$DEBIAN $BASE_URL/$DEBIAN_ARM $BASE_URL/$FEDORA $BASE_URL/$ALPINE_ARM